...
mepco_regions.each do |region_name|
  ...
  20.times do |i|
    subdivision.meters.create!(
      NEW_METER_NUMBER: "M#{region_name[0]}#{1000 + i}",
      REF_NO: "REF#{1000 + i}",
...
lesco_regions.each do |region_name|
  region = lesco.regions.create!(name: region_name)
  division = region.divisions.create!(name: "#{region_name} Division")
  subdivision = division.subdivisions.create!(name: "#{region_name} Subdivision")
  ...
  20.times do |i|
    subdivision.meters.create!(
      NEW_METER_NUMBER: "L#{region_name[0]}#{1000 + i}",
      REF_NO: "REF#{1000 + i}",
      METER_STATUS: ["Active", "Inactive", "Maintenance"].sample,
      OLD_METER_NUMBER: "OM#{1000 + i}",
      OLD_METER_READING: rand(100..1000),
...
fesco_regions.each do |region_name|
  region = fesco.regions.create!(name: region_name)
  division = region.divisions.create!(name: "#{region_name} Division")
  subdivision = division.subdivisions.create!(name: "#{region_name} Subdivision")
  ...
  20.times do |i|
    subdivision.meters.create!(
      NEW_METER_NUMBER: "F#{region_name[0]}#{1000 + i}",
      REF_NO: "REF#{1000 + i}",
      METER_STATUS: ["Active", "Inactive", "Maintenance"].sample,
      OLD_METER_NUMBER: "OM#{1000 + i}",
      OLD_METER_READING: rand(100..1000),
